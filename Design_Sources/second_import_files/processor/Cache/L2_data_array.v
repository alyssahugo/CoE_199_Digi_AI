...
module L2_data_array
    ...
    reg [127:0] r_data_to_core;
    
    reg [127:0] data_to_core;
    wire [127:0] out_blocks[CACHE_WAY-1:0]; // lots of wires 
    wire [127:0] data_out_from_way[CACHE_WAY-1:0];
    wire [31:0] tb_data_wire [CACHE_WAY-1:0];
    assign o_data_to_core = data_to_core;
    genvar i;
    generate
        for (i = 0; i < CACHE_WAY; i = i + 1) begin
            L2_data_mem_way # (.INDEX_BITS(INDEX_BITS)) 
                data_mem_way_n (
                    .clk(clk),
                    .i_wr(i_wr),
