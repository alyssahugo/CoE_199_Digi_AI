...
module qspi_bootloader
#(
    parameter integer WORDS_TO_COPY       = 100000,
    parameter [31:0] DDR_BASE_ADDRESS     = 32'h8000_0000,
    parameter [31:0] QSPI_BASE_ADDRESS    = 32'h44A0_0000,
    parameter [31:0] QSPI_FLASH_BASE      = 32'h0010_0000,
...
(
    ...
    // Old BRAM/ROM source ports.
    // Unused in this QSPI version.
    ...
    localparam [7:0]
        ...
        // DDR write
        S_DDR_WRITE_START       = 8'd40,
        S_DDR_WRITE_AFTER       = 8'd41,
        ...
        if (!nrst) begin
            ...
            case (state)
                ...
                S_WORD_START: begin
                    ...
                    ddr_addr      <= DDR_BASE_ADDRESS + (word_idx << 2);
                    tx_idx        <= 4'd0;
                    rx_idx        <= 4'd0;
                    rx_b0         <= 8'd0;
                    rx_b1         <= 8'd0;
...
//                        assembled_word <= {
//                            qspi_rdata_to_byte(read_data), // b3
//                            rx_b2,                         // b2
//                            rx_b1,                         // b1
//                            rx_b0                          // b0
//                        };
//                        state <= S_DDR_WRITE_START;
//                    end 
                    if (rx_idx == 4'd7) begin
                        assembled_word <= {
                            rx_b0,
                ...
                // Write assembled little-endian word to DDR
                // Flash bytes 70 65 72 73 become word 0x73726570.
//                S_DDR_WRITE_START: begin
//                    pending_addr  <= ddr_addr;
//                    pending_wdata <= assembled_word;
//                    pending_wstrb <= 4'b1111;
//                    return_state  <= S_DDR_WRITE_AFTER;
//                    state         <= S_AXI_WR_AW;
//                end
                S_DDR_WRITE_START: begin
                    // First QSPI transaction after init can return stale FF.
                ...
                S_ERROR: begin
                    // Do NOT release the CPU if the bootloader failed
                    done       <= 1'b0;
                    error_flag <= 1'b1;
