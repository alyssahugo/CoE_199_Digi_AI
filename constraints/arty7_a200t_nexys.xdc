...
#  -source [get_pins bd_target_fpga_i/clk_wiz_0/inst/clk_in1] \
#  -divide_by 4
#  [get_pins bd_target_fpga_i/clk_wiz_0/inst/clk_out1]

#create_generated_clock -name clk_out2 \
#  -source [get_pins bd_target_fpga_i/clk_wiz_0/inst/clk_in1] \
#  -multiply_by 2
#  [get_pins bd_target_fpga_i/clk_wiz_0/inst/clk_out2]
...
## LEDs
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { init_calib_complete }]; #IO_L15P_T2_DQS_13 Sch=led[0]
...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS15 } [get_ports { nrst }]; #IO_L12N_T1_MRCC_35 Sch=cpu_resetn
...
## Pmod header JA
#set_property -dict { PACKAGE_PIN AB22  IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L10N_T1_D15_14 Sch=ja[1]
